...
function dataProcessor(t) {
    return this.serverProcessor = t, this.action_param = "!nativeeditor_status",
        this.object = null, this.updatedRows = [], this.autoUpdate = !0, this.updateMode = "cell", this._tMode = "GET", this._headers = null, this._payload = null, this.post_delim = "_", this._waitMode = 0, this._in_progress = {}, this._invalid = {}, this.mandatoryFields = [], this.messages = [], this.styles = {
...
"undefined" == typeof window.dhx4 && (window.dhx4 = {
            ...
            selectTextRange: function(t, e, n) {
                ...
                if (e = Math.max(Math.min(e, i), 0), n = Math.min(n, i),
                    t.setSelectionRange) try {
                    t.setSelectionRange(e, n)
                } catch (a) {} else if (t.createTextRange) {
                    var s = t.createTextRange();
                    s.moveStart("character", e), s.moveEnd("character", n - i);
                    try {
                        s.select()
                    } catch (a) {}
                }
            ...
            transDetect: function() {
                if (null == this.transData) {
                    ...
                    for (var e in t) 0 == this.transData.transProp && null != document.documentElement.style[e] && (this.transData.transProp = e,
                        this.transData.transEv = t[e]);
                    t = null
                }
        ...
        }, window.dhx4.isIE = navigator.userAgent.indexOf("MSIE") >= 0 || navigator.userAgent.indexOf("Trident") >= 0, window.dhx4.isIE6 = null == window.XMLHttpRequest && navigator.userAgent.indexOf("MSIE") >= 0, window.dhx4.isIE7 = navigator.userAgent.indexOf("MSIE 7.0") >= 0 && navigator.userAgent.indexOf("Trident") < 0,
        ...
        xmltop: function(t, e, n) {
            if ("undefined" == typeof e.status || e.status < 400) {
                var i = e.responseXML ? e.responseXML || e : dhx4.ajax.parse(e.responseText || e);
                if (i && null !== i.documentElement && !i.getElementsByTagName("parsererror").length) return i.getElementsByTagName(t)[0];
        ...
        postLong: function(t, e, n) {
            2 == arguments.length && (n = e, e = ""),
                this._call("POST", t, e, !0, n, {
                    url: t,
                    postData: e
                })
        },
        _call: function(t, e, n, i, a, s, r) {
            ...
            if (1 == i && (o.onreadystatechange = function() {
                    if (4 == o.readyState || 1 == d && 3 == o.readyState) {
                        if ((200 != o.status || "" == o.responseText) && !dhx4.callEvent("onAjaxError", [o])) return;
                        window.setTimeout(function() {
                            "function" == typeof a && a.apply(window, [{
                                xmlDoc: o
                            }]), null != s && ("undefined" != typeof s.postData ? dhx4.ajax.postLong(s.url, s.postData, a) : dhx4.ajax.getLong(s.url, a)), a = null, o = null
                        }, 1)
                    }
                }), "GET" == t && 1 != this.cache && (e += (e.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), o.open(t, e, i), r)
                for (var _ in r) o.setRequestHeader(_, r[_]);
            else "POST" == t.toUpperCase() || "PUT" == t || "DELETE" == t ? o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == t && (n = null);
            return o.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                o.send(n), i ? void 0 : {
                    xmlDoc: o
                }
        }
        ...
        return "clear" == e ? (t.detachAllEvents(), t.dhxevs = null, t.attachEvent = null, t.detachEvent = null, t.checkEvent = null, t.callEvent = null, t.detachAllEvents = null, void(t = null)) : (t.dhxevs = {
            ...
            for (var e in this.dhxevs.data) {
                var n = 0;
                for (var i in this.dhxevs.data[e]) i == t ? (this.dhxevs.data[e][i] = null, delete this.dhxevs.data[e][i]) : n++;
            ...
            var n = !0;
            for (var i in this.dhxevs.data[t]) n = this.dhxevs.data[t][i].apply(this, e) && n;
            return n
        ...
        extend_api: function(t, e, n) {
            ...
            i && (window[t] = function(t) {
                if (t && "object" == typeof t && !t.tagName) {
                    var n = i.apply(this, e._init ? e._init(t) : arguments);
                    for (var a in dhtmlx) e[a] && this[e[a]](dhtmlx[a]);

                    for (var a in t) e[a] ? this[e[a]](t[a]) : 0 === a.indexOf("on") && this.attachEvent(a, t[a])
                } else var n = i.apply(this, arguments);
                return e._patch && e._patch(this), n || this
            }, window[t].prototype = i.prototype, n && dhtmlx.extend(window[t].prototype, n))
        },
        url: function(t) {
            return -1 != t.indexOf("?") ? "&" : "?"
        }
        ...
        _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])), "undefined" == typeof window.dhtmlxEvent, null == dhtmlxEvent.touchDelay && (dhtmlxEvent.touchDelay = 2e3), "undefined" == typeof dhtmlxEvent.initTouch && (dhtmlxEvent.initTouch = function() {
        function t() {
            if (n) {
        ...
        dhtmlxEvent(document.body, "touchstart", function(s) {
            n = s.touches[0].target, i = s.touches[0].clientX, a = s.touches[0].clientY, e = window.setTimeout(t, dhtmlxEvent.touchDelay);

        }), dhtmlxEvent(document.body, "touchmove", function(t) {
            e && (Math.abs(t.touches[0].clientX - i) > 50 || Math.abs(t.touches[0].clientY - a) > 50) && (window.clearTimeout(e), e = n = !1)
        }), dhtmlxEvent(document.body, "touchend", function(t) {
    ...
    function() {
        ...
        function e(e) {
            if (c) {
                ...
                return dhtmlx.message.keyboard && ((13 == n || 32 == n) && t(c, !0),
                    27 == n && t(c, !1)), e.preventDefault && e.preventDefault(), !(e.cancelBubble = !0)
            }
        }
        ...
        function a(t) {
            g.area || (g.area = document.createElement("DIV"),
        ...
        function l(t, e, n) {
            return "object" != typeof t && ("function" == typeof e && (n = e, e = ""),
                t = {
                    text: t,
                    type: e,
                    callback: n
        ...
        var g = dhtmlx.message = function(t, e, n, i) {
        ...
        g.seed = (new Date).valueOf(), g.uid = function() {
                return g.seed++
            }, g.expire = 4e3, g.keyboard = !0, g.position = "top",
            g.pull = {}, g.timers = {}, g.hideAll = function() {
        ...
        obj._silent_mode = !1, obj._silentStart = function() {
            ...
            return t = "ev_" + t.toLowerCase(),
                this[t] || (this[t] = new this._eventCatcher(n || this)), t + ":" + this[t].addEvent(e)
        ...
        if (t.getBoundingClientRect) {
            var i = t.getBoundingClientRect(),
                ...
                _ = s.clientLeft || a.clientLeft || 0;

            return e = i.top + r - d, n = i.left + o - _, {
                y: Math.round(e),
                x: Math.round(n),
                width: t.offsetWidth,
        ...
        i.id = "gantt_" + dhtmlx.uid(), i.style.width = "100%", i.style.height = "100%", i.cmp = "grid", n = n || window.gantt, document.body.appendChild(i), this.attachObject(i.id);
        var a = this.vs[this.av];
        a.grid = n, n.init(i.id, t, e), i.firstChild.style.border = "none", a.gridId = i.id, a.gridObj = i;
        var s = "_viewRestore";
        return this.vs[this[s]()].grid
    }), "undefined" != typeof window.dhtmlXCellObject && (dhtmlXCellObject.prototype.attachGantt = function(t, e, n) {
        var i = document.createElement("DIV");
        i.id = "gantt_" + dhtmlx.uid(), i.style.width = "100%", i.style.height = "100%", i.cmp = "grid", document.body.appendChild(i), this.attachObject(i.id), n = n || window.gantt, n.init(i.id, t, e), i.firstChild.style.border = "none";
        return i = null, this.callEvent("_onContentAttach", []), this.dataObj
        ...
        dragMove: function(t, e) {
            ...
            this.config.ignore || (e.pos = this.getPosition(e), this.config.marker.style.left = e.pos.x + "px", this.config.marker.style.top = e.pos.y + "px",
                this.callEvent("onDragMove", [t, e]))
        },
        dragEnd: function(t) {
        ...
        this._click.gantt_close = dhtmlx.bind(function(t, e, n) {
            return this.close(e), !1
        }, this), this._click.gantt_open = dhtmlx.bind(function(t, e, n) {
            return this.open(e), !1
        }, this), this._click.gantt_row = dhtmlx.bind(function(t, e, n) {
            if (null !== e) {
                var i = this.getTask(e);
                this.config.scroll_on_click && this.showDate(i.start_date), this.callEvent("onTaskRowClick", [e, n])
            }
        ...
        }, this), !this.config.sort && this.config.order_branch && this._init_dnd(), this._click.gantt_add = dhtmlx.bind(function(t, e, n) {
            if (!this.config.readonly) {
                var i = {};
                return this.createTask(i, e ? e : this.config.root_id), !1
            }
        ...
        for (var t = this.getGridColumns(), e = [], n = 0, i = this.locale.labels, a = this.config.scale_height - 2, s = 0; s < t.length; s++) {
            ...
            var d = this._sort && o.name == this._sort.name ? "<div class='gantt_sort gantt_" + this._sort.direction + "'></div>" : "",
                _ = ["gantt_grid_head_cell", "gantt_grid_head_" + o.name, r ? "gantt_last_cell" : "", this.templates.grid_header_class(o.name, o)].join(" "),
                l = "width:" + (o.width - (r ? 1 : 0)) + "px;",
                h = o.label || i["column_" + o.name];

            h = h || "";
            var c = "<div class='" + _ + "' style='" + l + "' column_id='" + o.name + "'>" + h + d + "</div>";
            e.push(c)
        }
        ...
        for (var e = this.getGridColumns(), n = [], i = 0; i < e.length; i++) {
            ...
            var d = "gantt_cell" + (r ? " gantt_last_cell" : ""),
                _ = "";
            if (o.tree) {
                for (var l = 0; l < t.$level; l++) _ += this.templates.grid_indent(t);
                var h = this._has_children(t.id);
                h ? (_ += this.templates.grid_open(t), _ += this.templates.grid_folder(t)) : (_ += this.templates.grid_blank(t), _ += this.templates.grid_file(t))
            }
            var c = "width:" + (o.width - (r ? 1 : 0)) + "px;";
            dhtmlx.defined(o.align) && (c += "text-align:" + o.align + ";"), a = "<div class='" + d + "' style='" + c + "'>" + _ + s + "</div>",
                n.push(a)
        }
        ...
        if (i) {
            if (i === t) return;
            n = this.getParent(i), e = this.getTaskIndex(i)
        }
        if (t != n) {
            n = n || this.config.root_id;
            var a = this.getTask(t),
                s = this.getParent(a.id),
                r = (this.getChildren(this.getParent(a.id)), this.getChildren(n));
            ...
            if (this.callEvent("onBeforeTaskMove", [t, n, e]) !== !1) {
                ...
                var d = r[e];
                d ? r = r.slice(0, e).concat([t]).concat(r.slice(e)) : r.push(t), this.setParent(a, n), this._branches[n] = r;
                for (var _ = this._getTaskTree(t), l = 0; l < _.length; l++) {
                    var h = this._pull[_[l]];
                    h && (h.$level = this.calculateTaskLevel(h))
                }
                a.$drop_target = 1 * e > 0 ? i ? (this.getTaskIndex(t) > this.getTaskIndex(i) ? "next:" : "") + i : "next:" + gantt.getPrevSibling(t) : r[1 * e + 1] ? r[1 * e + 1] : n, this.callEvent("onAfterTaskMove", [t, n, e]) && this.refreshData()
            }
        }
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", dhtmlx.bind(function(e, n) {
            ...
            t.config.index = this.getTaskIndex(t.config.id), t.config.parent = a.parent, a.$open = !1, a.$transparent = !0, this.refreshData()
            ...
            var e = this._get_position(this.$grid_data),
                ...
                i = t.pos.y - 10;
            return i < e.y && (i = e.y),
                i > e.y + this.$grid_data.offsetHeight - this.config.row_height && (i = e.y + this.$grid_data.offsetHeight - this.config.row_height), e.x = n, e.y = i, e
            ...
            if (this.isTaskExists(o) || (o = t.lastTaskOfLevel(d.$level),
                    o == t.config.id && (o = null)), this.isTaskExists(o)) {
                var _ = gantt._get_position(r),
                    l = this.getTask(o);
                if (_.y + r.offsetHeight / 2 < s) {
                    var h = this.getGlobalTaskIndex(l.id),
                        c = this._pull[this._order[h + 1]];
                    if (c) {
                        if (c.id == d.id) return;
                        l = c
                    } else if (c = this._pull[this._order[h]], c.$level == d.$level && c.id != d.id) return void this.moveTask(d.id, -1, this.getParent(c.id))
                }
                for (var h = this.getGlobalTaskIndex(l.id), g = this._pull[this._order[h - 1]], u = 1;
                    (!g || g.id == l.id) && h - u >= 0;) g = this._pull[this._order[h - u]], u++;
                if (d.id == l.id) return;
                l.$level == d.$level && d.id != l.id ? this.moveTask(d.id, 0, 0, l.id) : l.$level != d.$level - 1 || gantt.getChildren(l.id).length ? g && g.$level == d.$level && d.id != g.id && this.moveTask(d.id, -1, this.getParent(g.id)) : this.moveTask(d.id, 0, l.id)
            }
            return !0
        }, this)), t.attachEvent("onDragEnd", dhtmlx.bind(function() {
            var e = this.getTask(t.config.id);
            this.callEvent("onBeforeRowDragEnd", [t.config.id, t.config.parent, t.config.index]) === !1 ? (this.moveTask(t.config.id, t.config.index, t.config.parent), e.$drop_target = null) : this.callEvent("onRowDragEnd", [t.config.id, e.$drop_target]),
                e.$transparent = !1, e.$open = t.config.initial_open_state, this.refreshData()
        }, this))
        ...
        prepareConfigs: function(t, e, n, i) {
            for (var a = this.splitSize(i, t.length), s = n, r = [], o = t.length - 1; o >= 0; o--) {
                var d = o == t.length - 1,
                    _ = this.initScaleConfig(t[o]);
                d && this.processIgnores(_), this.initColSizes(_, e, s, a[o]), this.limitVisibleRange(_), d && (s = _.full_width), r.unshift(_)
            }
        ...
        iterateScales: function(t, e, n, i, a) {
            for (var s = e.trace_x, r = t.trace_x, o = n || 0, d = i || r.length - 1, _ = 0, l = 1; l < s.length; l++)
                for (var h = o; d >= h; h++) + r[h] != +s[l] || (a && a.apply(this, [_, l, o, h]),
                    o = h, _ = l)
        },
        ...
        eachColumn: function(t, e, n) {
            ...
            var s = new Date(i);
            for (+s >= +a && (a = gantt.date.add(s, e, t)); + a > +s;) {
                n.call(this, new Date(s));
                var r = s.getTimezoneOffset();
                s = gantt.date.add(s, e, t), s = gantt._correct_dst_change(s, r, e, t),
                    gantt.date[t + "_start"] && (s = gantt.date[t + "_start"](s))
            }
        },
        limitVisibleRange: function(t) {
            ...
            if (a) {
                for (var _ = this.getSum(t.width), l = 0, h = 0; h < t.width.length; h++) {
                    var c = Math.floor(a * (t.width[h] / _));
                    t.width[h] += c, l += c
                }
                this.adjustSize(a - l, t.width)
            }
        }
    }, gantt._tasks_dnd = {
        drag: null,
        ...
        init: function() {
            ...
            this._handlers[t.move] = this._move, this._handlers[t.resize] = this._resize,
        ...
        _resize: function(t, e, n) {
            ...
            n.left ? (t.start_date = gantt.dateFromPos(a.start + e), t.start_date || (t.start_date = new Date(gantt.getState().min_date))) : (t.end_date = gantt.dateFromPos(a.end + e), t.end_date || (t.end_date = new Date(gantt.getState().max_date))), t.end_date - t.start_date < i.min_duration && (n.left ? t.start_date = gantt.calculateEndDate(t.end_date, -1) : t.end_date = gantt.calculateEndDate(t.start_date, 1)), gantt._init_task_timing(t)
        },
        ...
        _move: function(t, e, n) {
            var i = this._drag_task_coords(t, n),
                a = gantt.dateFromPos(i.start + e),
                s = gantt.dateFromPos(i.end + e);
            a ? s ? (t.start_date = a, t.end_date = s) : (t.end_date = new Date(gantt.getState().max_date), t.start_date = gantt.dateFromPos(gantt.posFromDate(t.end_date) - (i.end - i.start))) : (t.start_date = new Date(gantt.getState().min_date), t.end_date = gantt.dateFromPos(gantt.posFromDate(t.start_date) + (i.end - i.start)))
        },
            ...
            if (e.mode) {
                ...
                if (this._handlers[e.mode]) {
                    var r = dhtmlx.mixin({}, s),
                        o = dhtmlx.mixin({}, s);
                    this._handlers[e.mode].apply(this, [o, a, e]),
                        dhtmlx.mixin(s, o, !0), gantt._update_parents(e.id, !0), gantt.callEvent("onTaskDrag", [s.id, e.mode, o, r, t]), dhtmlx.mixin(s, o, !0), gantt._update_parents(e.id), gantt.refreshTask(e.id)
                }
            }
        },
        ...
        _fix_dnd_scale_time: function(t, e) {
            ...
            var a = gantt._tasks.unit,
                s = gantt._tasks.step;
            gantt.config.round_dnd_dates || (a = "minute", s = gantt.config.time_step), e.mode == gantt.config.drag_mode.resize ? e.left ? (t.start_date = gantt.roundDate({
                date: t.start_date,
                unit: a,
                step: s
                ...
                unit: a,
                step: s
            }), i(t)) : e.mode == gantt.config.drag_mode.move && (t.start_date = gantt.roundDate({
                date: t.start_date,
                unit: a,
                step: s
            ...
            if (e.mode && e.id) {
                ...
                if (gantt.config.work_time && gantt.config.correct_work_time && this._fix_working_times(n, e), this._fix_dnd_scale_time(n, e), gantt._init_task_timing(n), this._fireEvent("before_finish", e.mode, [e.id, e.mode, dhtmlx.copy(e.obj), t])) {
                    ...
                    gantt._init_task_timing(n),
                        this._fireEvent("after_finish", e.mode, [i, e.mode, t]), this.clear_drag_state(), gantt.updateTask(n.id)
        ...
        _fireEvent: function(t, e, n) {
            ...
            return dhtmlx.assert(i, "Unknown after drop mode:{" + e + "}"),
                dhtmlx.assert(n, "Invalid event arguments"), gantt.checkEvent(i) ? gantt.callEvent(i, n) : !0
        }
        ...
        for (var e = this.getLink(t), n = gantt._get_link_renderers(), i = 0; i < n.length; i++) n[i].render_item(e)
        ...
        var _ = i[i.length - 1].direction,
            l = gantt._render_link_arrow(e[e.length - 1], _);

        return t.color && (l.style.borderColor = t.color), a.appendChild(l), a
        ...
        get_wrapper_sizes: function(t) {
            var e, n = gantt.config.link_wrapper_width,
                i = (gantt.config.link_line_width,
        ...
        get_points: function(t) {
            ...
            if (t.type == gantt.config.links.start_to_start) this.point_to(s.left, r), o ? (this.point_to(s.down, i), this.point_to(s.right, a)) : (this.point_to(s.right, a), this.point_to(s.down, i)), this.point_to(s.right, r);
                ...
                if (o = e.e_x > e.x - 2 * r, this.point_to(s.left, r), o) {
                    a += 2 * r;
                    var d = i > 0 ? 1 : -1;
                    this.point_to(s.down, d * (n.row_height / 2)),
                        this.point_to(s.right, a), this.point_to(s.down, d * (Math.abs(i) - n.row_height / 2)), this.point_to(s.left, r)
        ...
        function s(t, e, n, a) {
            ...
            gantt.templates.link_direction_class && l.push(gantt.templates.link_direction_class(_.from, _.from_start, _.to, _.to_start));
            ...
            if (h = Math.max(0, h - 3)) {
                ...
                var u = Math.sin(g),
                    ...
                    p = Math.round(e),
                    v = Math.round(t),
                    m = ["-webkit-transform: rotate(" + g + "rad)", "-moz-transform: rotate(" + g + "rad)", "-ms-transform: rotate(" + g + "rad)", "-o-transform: rotate(" + g + "rad)", "transform: rotate(" + g + "rad)", "width:" + Math.round(h) + "px"];
        ...
        l.attachEvent("onBeforeDragStart", dhtmlx.bind(function(e, n) {
            var i = n.target || n.srcElement;
            ...
            return !1
        }, this)), l.attachEvent("onAfterDragStart", dhtmlx.bind(function(t, n) {
            e(l.config.marker)
        }, this)), l.attachEvent("onDragMove", dhtmlx.bind(function(i, a) {
            var r = l.config,
                o = l.getPosition(a);
            n(r.marker, o);

            var d = gantt._is_link_drop_area(a),
                _ = gantt._link_target_task,
            ...
            var x = !(h == d && _ == f && g == p);
            return x && (_ && gantt.refreshTask(_, !1),
                f && gantt.refreshTask(f, !1)), x && e(r.marker), s(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y), !0
            ...
            a(), t.from && gantt.refreshTask(t.from, !1), t.to && gantt.refreshTask(t.to, !1), _()
        ...
        this._tasks = {
            ...
            trace_x: [],
            rendered: {}
        }, this._click.gantt_task_link = dhtmlx.bind(function(t, e) {
            var n = this.locate(t, gantt.config.link_attribute);
            n && this.callEvent("onLinkClick", [n, t])
        }, this), this._click.gantt_scale_cell = dhtmlx.bind(function(t, e) {
            var n = gantt._get_mouse_pos(t),
                i = gantt.dateFromPos(n.x),
                a = Math.floor(gantt._day_index_by_date(i)),
                s = gantt._tasks.trace_x[a];
            gantt.callEvent("onScaleClick", [t, s])
        }, this), this._dbl_click.gantt_task_link = dhtmlx.bind(function(t, e, n) {
        ...
        for (var s = 0; s < t.count; s++) {
            ...
            var r = i.call(this, n),
                ...
                l = "";
            if (o) {
                d = "width:" + o + "px;", l = "gantt_scale_cell" + (s == t.count - 1 ? " gantt_last_cell" : ""),
                    _ = a.call(this, n), _ && (l += " " + _);
                var h = "<div class='" + l + "' style='" + d + "'>" + r + "</div>";
                e.push(h)
            }
        }
        return e.join("")
        ...
        if (this._is_chart_visible()) {
            ...
            for (var r = this._get_resize_options(), o = r.x ? Math.max(this.config.autosize_min_width, 0) : this.$task.offsetWidth, d = a.prepareConfigs(s, this.config.min_column_width, o, i), _ = this._tasks = d[d.length - 1], l = [], h = this.templates.scale_row_class, c = 0; c < d.length; c++) {
                var g = "gantt_scale_line",
                    u = h(d[c]);
                u && (g += " " + u), l.push('<div class="' + g + '" style="height:' + d[c].height + "px;line-height:" + d[c].height + 'px">' + this._prepare_scale_html(d[c]) + "</div>")
            }
            t = l.join(""), e = _.full_width + this.$scroll_ver.offsetWidth + "px", n = _.full_width + "px", i += "px"
        }
        ...
        if (gantt.config.show_task_cells)
            for (var a = 0; n > a; a++) {
                ...
                if (s > 0) {
                    ...
                    o.style.width = s + "px", r = "gantt_task_cell" + (a == n - 1 ? " gantt_last_cell" : ""), _ = this.templates.task_cell_class(t, e.trace_x[a]), _ && (r += " " + _), o.className = r, i.appendChild(o)
                }
            }
        var d = t.$index % 2 !== 0,
            _ = gantt.templates.task_row_class(t.start_date, t.end_date, t),
            l = "gantt_task_row" + (d ? " odd" : "") + (_ ? " " + _ : "");
        return this.getState().selected_task == t.id && (l += " gantt_selected"), i.className = l, i.style.height = gantt.config.row_height + "px",
            i.setAttribute(this.config.task_attribute, t.id), i
        ...
        var a = gantt.getState(),
            s = this.getTask(n);
        this._get_safe_type(s.type) == this.config.types.milestone && i.push("gantt_milestone"),
            this._get_safe_type(s.type) == this.config.types.project && i.push("gantt_project"), this._is_flex_task(s) && i.push("gantt_dependent_task"), this.config.select_task && n == a.selected_task && i.push("gantt_selected"), n == a.drag_id && (i.push("gantt_drag_" + a.drag_mode), a.touch_drag && i.push("gantt_touch_" + a.drag_mode));
        var r = gantt._get_link_state();
        if (r.link_source_id == n && i.push("gantt_link_source"), r.link_target_id == n && i.push("gantt_link_target"), this.config.highlight_critical_path && this.isCriticalTask && this.isCriticalTask(s) && i.push("gantt_critical_task"),
            r.link_landing_area && r.link_target_id && r.link_source_id && r.link_target_id != r.link_source_id) {
            var o = r.link_source_id,
                d = r.link_source_start,
                _ = r.link_target_start,
                l = gantt.isLinkAllowed(o, n, d, _),
                h = "";
            h = l ? _ ? "link_start_allow" : "link_finish_allow" : _ ? "link_start_deny" : "link_finish_deny", i.push(h)
        }
        return i.join(" ")
        ...
        var _ = this._combine_item_class("gantt_task_line", this.templates.task_class(t.start_date, t.end_date, t), t.id);
        (t.color || t.progressColor || t.textColor) && (_ += " gantt_task_inline_color"),
        s.className = _;
        var l = ["left:" + e.x + "px", "top:" + (a + e.y) + "px", "height:" + i + "px", "line-height:" + i + "px", "width:" + r + "px"];
        t.color && l.push("background-color:" + t.color), t.textColor && l.push("color:" + t.textColor), s.style.cssText = l.join(";");
        ...
        var e = this.config.type_renderers,
            ...
            i = this._task_default_render;
        return n || (n = i), n.call(this, t, dhtmlx.bind(i, this));
        ...
        var n = document.createElement("div");
        return this._get_safe_type(t.type) != this.config.types.milestone && (n.innerHTML = this.templates.task_text(t.start_date, t.end_date, t)), n.className = "gantt_task_content", n
    }, gantt._render_task_progress = function(t, e, n) {
        var i = 1 * t.progress || 0;
        n = Math.max(n - 2, 0);
        var a = document.createElement("div"),
            s = Math.round(n * i);
        if (s = Math.min(n, s), t.progressColor && (a.style.backgroundColor = t.progressColor, a.style.opacity = 1), a.style.width = s + "px",
            a.className = "gantt_task_progress", a.innerHTML = this.templates.progress_text(t.start_date, t.end_date, t), e.appendChild(a), this.config.drag_progress && !gantt._is_readonly(t)) {
        ...
        var n = Math.floor(e),
            i = e % 1,
            a = gantt._tasks.left[Math.min(n, gantt._tasks.width.length - 1)];
        return n == gantt._tasks.width.length && (a += gantt._tasks.width[gantt._tasks.width.length - 1]),
            i && (a += n < gantt._tasks.width.length ? gantt._tasks.width[n] * (i % 1) : 1), a
        ...
        for (var a = gantt._findBinary(n, e), s = +gantt._tasks.trace_x[a]; i[s];) s = gantt._tasks.trace_x[++a];
        return s ? a + (t - n[a]) / gantt._get_coll_duration(gantt._tasks, n[a]) : 0
    }, gantt._findBinary = function(t, e) {
        for (var n, i, a, s = 0, r = t.length - 1; r >= s;)
            if (n = Math.floor((s + r) / 2),
                i = +t[n], a = +t[n - 1], e > i) s = n + 1;
            else {
                if (!(i > e)) return n;
                if (!isNaN(a) && e > a) return n - 1;
                r = n - 1
            }
        return t.length - 1
        ...
        return this._task_area_pulls || (this._task_area_pulls = {}),
            this._task_area_renderers || (this._task_area_renderers = {}), this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || dhtmlx.assert(!1, "Invalid renderer call"), n && n.setAttribute(this.config.layer_attribute, !0), this._task_area_renderers[t] = {
                ...
                clear: function(e) {
                    this.rendered = gantt._task_area_pulls[t] = {},
                        e = e || n, e && (e.innerHTML = "")
                },
        ...
        prepareConfig: function(t) {
            ...
            t.id = dhtmlx.uid();
            return t.container || (t.container = document.createElement("div")),
                t
        },
        create: function(t, e) {
            return {
                ...
                add: function(t) {
                    if (t && this.tempCollection.push(t), this.container())
                        for (var n = this.container(), i = this.tempCollection, a = 0; a < i.length; a++) {
                            var t = i[a],
                                s = t.container,
                                r = t.id,
                                o = t.topmost;
                            if (!s.parentNode)
                                if (o) n.appendChild(s);
                                    ...
                                    var d = e ? e() : n.firstChild;
                                    d ? n.insertBefore(s, d) : n.appendChild(s);

                                }
                            this.renderers[r] = gantt._task_renderer(r, t.renderer, s, t.filter), this.tempCollection.splice(a, 1), a--
                        }
                },
                remove: function(t) {
    ...
    gantt.removeLinkLayer = function(t) {
        ...
        var i = "json",
            a = null;
        arguments.length >= 3 ? (i = e, a = n) : "string" == typeof arguments[1] ? i = arguments[1] : "function" == typeof arguments[1] && (a = arguments[1]),
            this._load_type = i, dhx4.ajax.get(t, dhtmlx.bind(function(t) {
        ...
        for (var e, n = t.data, i = 0; i < n.length; i++) e = n[i], this._init_task(e), this.callEvent("onTaskLoading", [e]) && (this._pull[e.id] = e);
        for (var i in this._pull) e = this._pull[i], this.setParent(e, this.getParent(e) || this.config.root_id);
        for (var i in this._pull) e = this._pull[i], this._add_branch(e, !0), e.$level = this.calculateTaskLevel(e);
        if (this._sync_order(), this._init_links(t.links || (t.collections ? t.collections.links : [])), this.callEvent("onParse", []), this.render(),
            this.config.initial_scroll) {
        ...
        parse: function(data) {
            return dhtmlx.assert(data, "Invalid data"), "string" == typeof data && (window.JSON ? data = JSON.parse(data) : (gantt._temp = eval("(" + data + ")"),
                data = gantt._temp || {}, gantt._temp = null)), data.dhx_security && (dhtmlx.security_key = data.dhx_security), data
        },
        ...
        _getCollections: function(t) {
            for (var e = {}, n = dhx4.ajax.xpath("//coll_options", t), i = 0; i < n.length; i++)
                for (var a = n[i].getAttribute("for"), s = e[a] = [], r = dhx4.ajax.xpath(".//item", n[i]), o = 0; o < r.length; o++) {
                    for (var d = r[o], _ = d.attributes, l = {
                            key: r[o].getAttribute("value"),
                            label: r[o].getAttribute("label")
                        }, h = 0; h < _.length; h++) {
                        var c = _[h];
                        "value" != c.nodeName && "label" != c.nodeName && (l[c.nodeName] = c.nodeValue)
                    }
                    s.push(l)
                }
            return e
        ...
        _getXML: function(t, e, n) {
            ...
            var i = dhx4.ajax.xmltop(n, e.xmlDoc);
            if (i.tagName != n) throw "Invalid XML data";
            var a = i.getAttribute("dhx_security");
            return a && (dhtmlx.security_key = a), i
        },
        parse: function(t, e) {
            e = this._getXML(t, e);
            for (var n = {}, i = n.data = [], a = dhx4.ajax.xpath("//task", e), s = 0; s < a.length; s++) i[s] = this._xmlNodeToJSON(a[s]);
        ...
        parse: function(t, e) {
            ...
            for (var n = {
                ...
                }, i = n.data = [], a = dhx4.ajax.xpath("//task", e), s = 0; s < a.length; s++) {
        ...
        _working_units_cache: {
            ...
            get: function(t, e) {
                ...
                var n = this._cache,
                    i = e.getTime(),
                    a = -1;
                return n && n[t] && void 0 !== n[t][i] && (a = n[t][i]), a
            },
            put: function(t, e, n) {
                if (!t || !e) return !1;
                var i = this._cache,
                    a = e.getTime();
                return n = !!n, i ? (i[t] || (i[t] = {}), i[t][a] = n, !0) : !1
            },
            clear: function() {
                this._cache = {}
            }
        ...
        is_working_unit: function(t, e, n) {
            ...
            var i = this._working_units_cache.get(e, t);
            return -1 == i && (i = this._check_is_working_unit(t, e, n), this._working_units_cache.put(e, t, i)), i
        },
        ...
        get_work_units_between: function(t, e, n, i) {
            if (!n) return !1;
            for (var a = new Date(t), s = new Date(e), i = i || 1, r = 0; a.valueOf() < s.valueOf();) this.is_working_unit(a, n) && r++,
                a = gantt.date.add(a, i, n);
            return r
        },
        is_work_units_between: function(t, e, n, i) {
            if (!n) return !1;
            for (var a = new Date(t), s = new Date(e), i = i || 1; a.valueOf() < s.valueOf();) {
                if (this.is_working_unit(a, n)) return !0;
                a = gantt.date.add(a, i, n)
            }
            return !1
        },
        ...
        get_closest_worktime: function(t) {
            ...
            var e = t.unit,
                ...
                d = "any" == t.dir || !t.dir,
                _ = 1;
            for ("past" == t.dir && (_ = -1); !this.is_working_unit(n, e);) {
                d && (n = s ? i : a, _ = -1 * _);
                var l = n.getTimezoneOffset();
                if (n = gantt.date.add(n, _, e), n = gantt._correct_dst_change(n, l, _, e), gantt.date[e + "_start"] && (n = gantt.date[e + "_start"](n)), d && (s ? i = n : a = n), s = !s, o++, o > r) return dhtmlx.assert(!1, "Invalid working time check"), !1
            }
        ...
        for (var i = this.getChildren(n), a = !1, s = 0, r = i.length; r > s; s++)
            if (i[s] == t.id) {
                a = !0;
                break
            }
        a || i.push(t.id), this._sync_parent(t), this._sync_order(e)
        ...
        return dhtmlx.defined(e) || (e = this.getParent(t) || 0), this.isTaskExists(e) || (e = 0), this.setParent(t, e), t = this._init_task(t), this.callEvent("onBeforeTaskAdd", [t.id, t]) === !1 ? !1 : (this._pull[t.id] = t,
            this._add_branch(t), this.refreshData(), this._adjust_scales(), this.callEvent("onAfterTaskAdd", [t.id, t]), t.id)
        ...
        n && (this._dp.setUpdateMode(i), a && this._dp.sendAllData())
    }, gantt._deleteRelatedTasks = function(t, e) {
        var n = this._dp && !e,
            i = "";
        n && (i = this._dp.updateMode, this._dp.setGanttMode("tasks"), this._dp.setUpdateMode("off"));
        for (var a = this._getTaskTree(t), s = 0; s < a.length; s++) {
            var r = a[s];
            this._unset_task(r), n && this._dp.setUpdated(r, !0, "deleted")
        }
        n && this._dp.setUpdateMode(i)
        ...
        for (var i in this._pull) {
            var a = this._pull[i];
            this.getParent(a) == t && this.setParent(a, e)
        }
        ...
        return t instanceof Date && (t = {
                date: t
            }), t.dir = t.dir || "any", t.unit = t.unit || this.config.duration_unit,
            e.get_closest_worktime(t)
        ...
        return this.eachTask(function(t) {
            this._get_safe_type(t.type) != gantt.config.types.project && (t.start_date && !t.$no_start && (!e || e > t.start_date.valueOf()) && (e = t.start_date.valueOf()),
        ...
        if (t) {
            for (var n = this.getTask(t), i = this.getParent(n); !n.$no_end && !n.$no_start && i && this.isTaskExists(i);) n = this.getTask(i),
                i = this.getParent(n);
            (n.$no_start || n.$no_end) && (gantt.resetProjectDates(n), e || this.refreshTask(n.id, !0)), i && this.isTaskExists(i) && this._update_parents(i, e)
        }
    }, gantt.isChildOf = function(t, e) {
        if (!this.isTaskExists(t)) return !1;
        if (e === this.config.root_id) return this.isTaskExists(t);
        for (var n = this.getTask(t), i = this.getParent(t); n && this.isTaskExists(i);) {
            if (n = this.getTask(i), n && n.id == e) return !0;
            i = this.getParent(n)
        }
        return !1
        ...
        var e, n, i = t.date,
            a = t.step,
            s = t.unit;
        if (s == gantt._tasks.unit && a == gantt._tasks.step && +i >= +gantt._min_date && +i <= +gantt._max_date) {
            var r = Math.floor(gantt._day_index_by_date(i));
            n = new Date(gantt._tasks.trace_x[r]), e = new Date(n), gantt._tasks.trace_x[r + 1] && (e = new Date(gantt._tasks.trace_x[r + 1]))
        } else {
            for (e = gantt.date[s + "_start"](new Date(this._min_date)); + i > +e;) {
                e = gantt.date[s + "_start"](gantt.date.add(e, a, s));
                var o = e.getTimezoneOffset();
                e = gantt.date.add(e, a, s), e = gantt._correct_dst_change(e, o, e, s), gantt.date[s + "_start"] && (e = gantt.date[s + "_start"](e));

            }
            n = gantt.date.add(e, -1 * a, s)
        }
        ...
        return e
    }, gantt.sort = function(t, e, n, i) {
        var a = !i;
        this.isTaskExists(n) || (n = this.config.root_id),
            t || (t = "order");
        var s = "string" == typeof t ? function(n, i) {
                if (n[t] == i[t]) return 0;
                var a = n[t] > i[t];
                return e && (a = !a), a ? 1 : -1
            } : t,
            r = this.getChildren(n);
        if (r) {
            for (var o = [], d = r.length - 1; d >= 0; d--) o[d] = this._pull[r[d]];
            o.sort(s);
            for (var d = 0; d < o.length; d++) r[d] = o[d].id, this.sort(t, e, r[d], !0)
        }
        a && this.render()
        ...
        t.setTransactionMode("POST", !0), t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", t._serverProcessor = t.serverProcessor, t.styles = {
                ...
                error: "gantt_error",
                clear: ""
            }, t._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"],
            t.setGanttMode = function(e) {
                var n = t.modes || {};
        ...
        t.afterUpdate = function() {
            ...
            var i = t._ganttMode,
                a = n.filePath;
            i = "REST" != this._tMode ? -1 != a.indexOf("gantt_mode=links") ? "links" : "tasks" : a.indexOf("/link") > a.indexOf("/task") ? "links" : "tasks", t.setGanttMode(i);
            var s = e.apply(t, arguments);
            return t.setGanttMode(i), s
        }, t._getRowData = dhtmlx.bind(function(e, n) {
            var i;
            i = "tasks" == t._ganttMode ? this.isTaskExists(e) ? this.getTask(e) : {
                id: e
            ...
            for (var s in i)
                if ("$" != s.substr(0, 1)) {
                    var r = i[s];
                    a[s] = r instanceof Date ? this.templates.xml_format(r) : null === r ? "" : r
                }
            return i.$no_start && (i.start_date = "", i.duration = ""), i.$no_end && (i.end_date = "", i.duration = ""), a[t.action_param] = this.getUserData(e, t.action_param), a
        ...
        }, this._delete_task = function(t, e) {}, this._dp = t, gantt._patch_dhx4_ajax()
    }, gantt._patch_dhx4_ajax = function() {
        var t = parseInt((dhx4.version || "").split(".").join(""), 10);
        413 >= t && (window.dhx4.ajax._call = function(t, e, n, i, a, s, r) {
            var o = window.XMLHttpRequest && !dhx4.isIE ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP"),
                d = null != navigator.userAgent.match(/AppleWebKit/) && null != navigator.userAgent.match(/Qt/) && null != navigator.userAgent.match(/Safari/);
            ...
            return o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.send(n), i ? void 0 : {
                xmlDoc: o,
                filePath: e
            }
        }), gantt._patch_dhx4_ajax = function() {}
        ...
        return dhtmlx.defined(e) || (e = this.getLink(t)), this.callEvent("onBeforeLinkUpdate", [t, e]) === !1 ? !1 : (this._lpull[t] = e, this._sync_links(),
            this._render_link(t), this.callEvent("onAfterLinkUpdate", [t, e]), !0)
        ...
        for (var i in e)("undefined" == typeof t[i] || n) && (t[i] = e[i])
        ...
        if (!gantt.skin || t)
            for (var e = document.getElementsByTagName("link"), n = 0; n < e.length; n++) {
                var i = e[n].href.match("dhtmlxgantt_([a-z]+).css");
                if (i) {
                    gantt.skin = i[1];
                    break
                }
        ...
        var a = gantt.skins[gantt.skin];
        this._configure(gantt.config, a.config, t);
        var s = gantt.getGridColumns();
        s[1] && "undefined" == typeof s[1].width && (s[1].width = a._second_column_width), s[2] && "undefined" == typeof s[2].width && (s[2].width = a._third_column_width), a._lightbox_template && (gantt._lightbox_template = a._lightbox_template), gantt.resetLightbox()
        ...
        return n ? (n.splice(0, n.length),
            n.push.apply(n, e || []), void gantt.resetLightbox()) : !1
        ...
        if (void 0 === t && (t = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
            ...
            (gantt.config.wide_form || n) && (e.className += " gantt_cal_light_wide"), n && (gantt.config.wide_form = !0,
                e.className += " gantt_cal_light_full"), e.style.visibility = "hidden";
            ...
            for (var d = e.getElementsByTagName("div"), s = 0; s < d.length; s++) {
                var _ = d[s];
                if ("gantt_cal_larea" == _.className) {
                    _.innerHTML = i;
                    break
                }
            }
        ...
        for (var e = "", n = 0; n < t.length; n++) {
            ...
            if (i) {
                ...
                var a = t[n].hidden ? " style='display:none'" : "",
                    s = "";
                t[n].button && (s = "<div class='gantt_custom_button' index='" + n + "'><div class='gantt_custom_button_" + t[n].button + "'></div><div>" + this.locale.labels["button_" + t[n].button] + "</div></div>"),
                    this.config.wide_form && (e += "<div class='gantt_wrap_section' " + a + ">"), e += "<div id='" + t[n].id + "' class='gantt_cal_lsection'>" + s + this.locale.labels["section_" + t[n].name] + "</div>" + i.render.call(this, t[n]), e += "</div>"
            }
        }
        return e
        ...
        gantt.lightbox_events = {}, gantt.lightbox_events.gantt_save_btn = function(t) {
            ...
            if (e.getAttribute("dhx_button")) gantt.callEvent("onLightboxButton", [e.className, e, t]);
                ...
                var n, i, a; - 1 != e.className.indexOf("gantt_custom_button") && (-1 != e.className.indexOf("gantt_custom_button_") ? (n = e.parentNode.getAttribute("index"),
                    a = e.parentNode.parentNode) : (n = e.getAttribute("index"), a = e.parentNode, e = e.firstChild));
        ...
        gantt.templates.lightbox_header ? (i[1].innerHTML = "", i[2].innerHTML = gantt.templates.lightbox_header(n.start_date, n.end_date, n)) : (i[1].innerHTML = this.templates.task_time(n.start_date, n.end_date, n),
            i[2].innerHTML = (this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70));
        for (var a = this._get_typed_lightbox_config(this.getLightboxType()), s = 0; s < a.length; s++) {
            ...
            if (this.form_blocks[r.type]) {
                var o = document.getElementById(r.id).nextSibling,
                    ...
                    _ = gantt._resolve_default_mapping(a[s]),
                    l = dhtmlx.defined(n[_]) ? n[_] : r.default_value;
                d.set_value.call(gantt, o, l, n, r), r.focus && d.focus.call(gantt, o)
            }
        }
        ...
        dhtmlxEvent(document.body, "mousemove", gantt._move_while_dnd),
            dhtmlxEvent(document.body, "mouseup", gantt._finish_dnd), gantt._init_dnd_events = function() {}
            ...
            for (var o = "", d = 0; d < n.length; d++) {
                ...
                switch (_) {
                    case "%Y":
                        ...
                        var h, c, g, u;
                        t.year_range && (isNaN(t.year_range) ? t.year_range.push && (g = t.year_range[0], u = t.year_range[1]) : h = t.year_range), h = h || 10, c = c || Math.floor(h / 2), g = g || a.getFullYear() - c, u = u || g + h;
                        for (var f = g; u > f; f++) l += "<option value='" + f + "'>" + f + "</option>";
                        break;
                    case "%m":
                    ...
                    case "%H:%i":
                        ...
                        for (t._time_values = []; s > f;) {
                            var v = this.templates.time_picker(a);
                            l += "<option value='" + f + "'>" + v + "</option>", t._time_values.push(f), a.setTime(a.valueOf() + 60 * this._get_timepicker_step() * 1e3);
                            var m = a.getDate() != p ? 1 : 0;
                            f = 24 * m * 60 + 60 * a.getHours() + a.getMinutes()
                        }
                }
                if (l) {
                    var k = t.readonly ? "disabled='disabled'" : "",
                        x = e ? " style='display:none'" : "";
                    o += "<select " + k + x + ">" + l + "</select>"
                }
            }
            return o
        },
        _fill_lightbox_select: function(t, e, n, i, a) {
        ...
        time: {
            ...
            set_value: function(t, e, n, i) {
                ...
                if (a.auto_end_date)
                    for (var o = function() {
                            l = new Date(s[r[2]].value, s[r[1]].value, s[r[0]].value, 0, 0), h = gantt.calculateEndDate(l, 1), this.form_blocks._fill_lightbox_select(s, r.size, h, r, a);

                        }, d = 0; 4 > d; d++) s[d].onchange = o;
                var _ = gantt._resolve_default_mapping(i);
                "string" == typeof _ && (_ = {
                    start_date: _
                });
                var l = n[_.start_date] || new Date,
                    h = n[_.end_date] || gantt.calculateEndDate(l, 1);
                this.form_blocks._fill_lightbox_select(s, 0, l, r, a), this.form_blocks._fill_lightbox_select(s, r.size, h, r, a)
            },
            get_value: function(t, e, n) {
                ...
                var _ = new Date(i[a[2] + a.size].value, i[a[1] + a.size].value, i[a[0] + a.size].value, s, r);
                d >= _ && (_ = gantt.date.add(d, gantt._get_timepicker_step(), "minute"));
                var l = gantt._resolve_default_mapping(n),
                    h = {
                        start_date: new Date(d),
                        end_date: new Date(_)
                    };
                return "string" == typeof l ? h.start_date : h
            },
            focus: function(t) {
        ...
        duration: {
            ...
            set_value: function(t, e, n, i) {
                ...
                function s(t) {
                    var e = _.value;
                    e = parseInt(e, 10), window.isNaN(e) && (e = 0), e += t, 1 > e && (e = 1), _.value = e, a()
                }
                var r = i,
                ...
                l[0].onclick = dhtmlx.bind(function() {
                    ...
                    s(1 * this.config.duration_step)
                }, this), o[0].onchange = a, o[1].onchange = a, o[2].onchange = a, o[3] && (o[3].onchange = a), _.onkeydown = dhtmlx.bind(function(t) {
                    t = t || window.event;
                ...
                }, this), _.onchange = dhtmlx.bind(function(t) {
                    a()
                }, this);
                var g = gantt._resolve_default_mapping(i);

                "string" == typeof g && (g = {
                    start_date: g
                });
                var u = n[g.start_date] || new Date,
                    f = n[g.end_date] || gantt.calculateEndDate(u, 1),
                    p = Math.round(n[g.duration]) || gantt.calculateDuration(u, f);
                gantt.form_blocks._fill_lightbox_select(o, 0, u, c, r), _.value = p, a()
            },
            _get_start_date: function(t, e) {
                ...
                if (dhtmlx.defined(i[3])) {
                    ...
                    isNaN(o) && r.hasAttribute("data-value") && (o = parseInt(r.getAttribute("data-value"), 10)), a = Math.floor(o / 60),
                        s = o % 60
                }
        ...
        setTransactionMode: function(t, e) {
            "object" == typeof t ? (this._tMode = t.mode || this._tMode, this._headers = this._headers || t.headers, this._payload = this._payload || t.payload) : (this._tMode = t, this._tSend = e), "REST" == this._tMode && (this._tSend = !1,
                this._endnm = !0)
        },
        escape: function(t) {
        ...
        ignore: function(t, e) {
            this._silent_mode = !0,
                t.call(e || window), this._silent_mode = !1
        },
        ...
        serialize_one: function(t, e) {
            ...
            for (var i in t)
                if (t.hasOwnProperty(i)) {
                    if (("id" == i || i == this.action_param) && "REST" == this._tMode) continue;
                    n.push(this.escape((e || "") + i) + "=" + this.escape(t[i]))
                }
            return n.join("&")
        },
        _sendData: function(t, e) {
            if (t) {
                ...
                var n = this,
                    ...
                    a = this.serverProcessor + (this._user ? dhtmlx.url(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + this.obj.getUserData(0, "version")].join("&") : "");

                if ("GET" == this._tMode) dhx4.ajax.get(a + (-1 != a.indexOf("?") ? "&" : "?") + this.serialize(t, e), i);
                else if ("POST" == this._tMode) dhx4.ajax.post(a, this.serialize(t, e), i);
                else if ("REST" == this._tMode) {
                    var s = this.getState(e),
                        r = a.replace(/(\&|\?)editing\=true/, ""),
                        o = "",
                        d = "post";
                    if ("inserted" == s ? o = this.serialize(t, e) : "deleted" == s ? (d = "DELETE", r = r + ("/" == r.slice(-1) ? "" : "/") + e) : (d = "PUT", o = this.serialize(t, e), r = r + ("/" == r.slice(-1) ? "" : "/") + e), this._payload)
                        for (var _ in this._payload) r = r + dhtmlx.url(r) + this.escape(_) + "=" + this.escape(this._payload[_]);
        ...
        _getAllData: function(t) {
            for (var e = {}, n = !1, i = 0; i < this.updatedRows.length; i++) {
                var a = this.updatedRows[i];
                this._in_progress[a] || this.is_invalid(a) || this.callEvent("onBeforeUpdate", [a, this.getState(a), this._getRowData(a)]) && (e[a] = this._getRowData(a, a + this.post_delim), n = !0, this._in_progress[a] = (new Date).valueOf())
            }
            return n ? e : null
        },
        ...
        afterUpdate: function(t, e, n) {
            if (window.JSON) try {
                var i = JSON.parse(e.xmlDoc.responseText),
                    a = i.action || this.getState(n) || "updated",
                    s = i.sid || n[0],
                    r = i.tid || n[0];
                return t.afterUpdateCallback(s, r, a, i), void t.finalizeUpdate()
            } catch (o) {}
            var d = dhx4.ajax.xmltop("data", e.xmlDoc);
            if (!d) return this.cleanUpdate(n);
            var _ = dhx4.ajax.xpath("//data/action", d);
            if (!_.length) return this.cleanUpdate(n);
            for (var l = 0; l < _.length; l++) {
                var h = _[l],
                    a = h.getAttribute("type"),
                    s = h.getAttribute("sid"),
                    r = h.getAttribute("tid");
                t.afterUpdateCallback(s, r, a, h);
        ...
        afterAutoUpdate: function(t, e, n, i) {
        ...
        this.callEvent("onBeforeGanttReady", []), e && n && (this.config.start_date = this._min_date = new Date(e), this.config.end_date = this._max_date = new Date(n)), this._init_skin(), this.config.scroll_size || (this.config.scroll_size = this._detectScrollSize()), dhtmlxEvent(window, "resize", this._on_resize), this.init = function(t) {
        ...
        this._init_html_area(t), this._set_sizes(), this._clear_renderers(), this.resetLightbox(), this._update_flags(), this._init_touch_events(), this._init_templates(), this._init_grid(), this._init_tasks(), this._set_scroll_events(), dhtmlxEvent(this.$container, "click", this._on_click), dhtmlxEvent(this.$container, "dblclick", this._on_dblclick), dhtmlxEvent(this.$container, "mousemove", this._on_mousemove), dhtmlxEvent(this.$container, "contextmenu", this._on_contextmenu),
            this.callEvent("onGanttReady", []), this.render()
        ...
        if (this._is_render_active()) {
            ...
            var t = dhtmlx.copy(this._restore_scroll_state()),
                e = null;
            if (t && (e = gantt.dateFromPos(t.x + this.config.task_scroll_offset)),
                this._render_grid(), this._render_tasks_scales(), this._scroll_resize(), this._on_resize(), this._render_data(), this.config.preserve_scroll && t) {
        ...
        function t(t) {
            ...
            if (i && Math.abs(i) > Math.abs(a)) {
                ...
                var o = gantt.$scroll_ver.scrollTop + 30 * s;
                if (!gantt.config.prevent_default_scroll && gantt._cached_scroll_pos && gantt._cached_scroll_pos.y == o) return !0;
        ...
        var e = gantt._get_target_node(t),
            n = e.className || "";
        if (n.indexOf || (n = ""), (n || "").indexOf("gantt_task_cell") >= 0) return null;
        for (var i = arguments[1] || this.config.task_attribute; e;) {
            if (e.getAttribute) {
        ...
        for (var i = gantt._get_target_node(t), a = ""; i;) {
            if (a = i.className, a && !a.indexOf && (a = ""), a) {
                var s = a.indexOf(e);
                if (s >= 0) {
                    if (!n) return i;
    ...
    }, gantt._correct_dst_change = function(t, e, n, i) {
        var a = gantt._get_line(i) * n;
        if (a > 3600 && 86400 > a) {
        ...
        return t
    }, gantt.batchUpdate = function(t) {
        var e, n = this._dp && "off" != this._dp.updateMode;
        n && (e = this._dp.updateMode, this._dp.setUpdateMode("off")), this._skip_render = !0;
        try {
            t()
        } catch (i) {}
        this._skip_render = !1, this.render(), n && (this._dp.setUpdateMode(e), this._dp.sendData())
    }, gantt.date = {
        init: function() {
    ...
    function() {
        dhtmlx.mixin(gantt.config, {
            ...
            this.config[t] && n[t] != this.config[t] && (e && this.templates[t] || (this.templates[t] = this.date.date_to_str(this.config[t]),
                n[t] = this.config[t])), this._reg_templates = n
        ...
        function a(t) {
            ...
            if (n && gantt.isTaskVisible(t))
                for (var i in e)
                    if (n = e[i][t],
                        n && n.getAttribute("task_id") && n.getAttribute("task_id") == t) {
                        var a = n.cloneNode(!0);
        ...
        this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1, dhtmlxEvent(gantt.$container, t[0], function(t) {
            if (!n(t) && o) {
                l && clearTimeout(l);
                var a = e(t);
                if (gantt._tasks_dnd.drag.id || gantt._tasks_dnd.drag.start_drag) return gantt._tasks_dnd.on_mouse_move(a), t.preventDefault && t.preventDefault(),
                    t.cancelBubble = !0, !1;
                if (a && _) {
                    var h = _.pageX - a.pageX,
                        c = _.pageY - a.pageY;
                    if (!d && (Math.abs(h) > 5 || Math.abs(c) > 5) && (gantt._touch_scroll_active = d = !0, r = 0, s = gantt.getScrollState()), d) {
                        gantt.scrollTo(s.x + h, s.y + c);
                        var g = gantt.getScrollState();
                        if (s.x != g.x && c > 2 * h || s.y != g.y && h > 2 * c) return i(t)
                    }
                }
                return i(t)
            }
            ...
            if (!n(t)) {
                ...
                if (o = !0, _ = e(t), _ && r) {
                    var s = new Date;
                    500 > s - r ? (gantt._on_dblclick(_), i(t)) : r = s
                } else r = new Date;
                l = setTimeout(function() {
                    var t = gantt.locate(_);
                    !t || gantt._locate_css(_, "gantt_link_control") || gantt._locate_css(_, "gantt_grid_data") || (gantt._tasks_dnd.on_mouse_down(_), gantt._tasks_dnd._start_dnd(_), gantt._touch_drag = !0, a(t), gantt.refreshTask(t), gantt._touch_feedback()), l = null
            ...
            if (!n(t)) {
                ...
                var i = e(t);
                gantt._tasks_dnd.on_mouse_up(i),
                    h && (gantt.refreshTask(gantt.locate(h)), h.parentNode.removeChild(h), gantt._touch_feedback()), gantt._touch_scroll_active = o = d = !1, h = null
            }
        })
    };
